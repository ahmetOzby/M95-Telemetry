#ifndef Magma_DATA_PACK_LIB_H_
#define Magma_DATA_PACK_LIB_H_
#include "stdint.h"
...
void Magma_UINT16toFLOAT_LE(float *packData, uint8_t const *packBuf, uint16_t CONVERTER, uint16_t *index);
